                ...
                .then(hashedPassword => {
                    ...
                    user.save()
                        .then(user => {
                            ...
                            let mailOptions =  {
                                from:'"Firstclassbrain" <firstclassbrain12@gmail.com>',
                                to:user.email,
                                                    ...
                                                    <tbody><tr>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" align="left" style="border: none; border-collapse: collapse; border-spacing: 0; mso-table-lspace: 0; mso-table-rspace: 0; table-layout: fixed; width: 100%;">
                                                            <tbody><tr>
                                                                ...
                                                                Your password current password is <b style="color:teal;">${user.generatedPassword}</b>
                                                                <br /><br />
                                                                ...
                                                                <br /><br />
                                                                <a href="https://investify.africa/verify-account/${user.emailToken}">https://investify.africa/verify-account/${user.emailToken}</a>
                                                                <br /><br />
